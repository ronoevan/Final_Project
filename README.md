...
- Configuration (config) file is currently being integrated to allow users to change or input new variables such as spike variant-specific mutations (features) of a new hCoV-19 variant, and change the name of newly trained Random Forest ML models. 
